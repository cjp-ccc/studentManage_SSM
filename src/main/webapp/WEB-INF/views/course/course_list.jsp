    ...
    <form id="addForm" method="post">
        <table id="addTable2" cellpadding="8">
            ...
            <%--<tr >--%>
                <%--<td>课程时间:</td>--%>
                <%--<td>--%>
                    <%--&lt;%&ndash;<select id="add_sex"  class="easyui-combobox" style="width: 200px;" name="sex" data-options="required:true, missingMessage:'请选择课程性别'">&ndash;%&gt;--%>
            ...
            <%--<tr>--%>
                <%--<td>已选课人数:</td>--%>
                <%--<td><input id="add_selectedNum" style="width: 200px; height: 30px;" class="easyui-textbox" type="text" name="selectedNum" data-options="multiline:true"  /></td>--%>
            <%--</tr>--%>
            <%--<tr>--%>
                <%--<td>最大选课人数:</td>--%>
                <%--<td><input id="add_maxNum" style="width: 200px; height: 30px;" class="easyui-textbox" type="text" name="maxNum" data-options="multiline:true"  /></td>--%>
            <%--</tr>--%>
            <%--<tr>--%>
                <%--<td>入学时间:</td>--%>
