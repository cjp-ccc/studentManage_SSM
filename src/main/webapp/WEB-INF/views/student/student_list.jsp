	    ...
	    $("#addDialog").dialog({
	  	...
	  	$("#search-btn").click(function(){
	  		$('#dataList').datagrid('reload',{
                ...
                admissionTime:$("#search-admissionTime").textbox('getValue'),
...
<body>
	...
	<div id="toolbar">
		...
		<div>
			...
			入学年份：<input id="search-admissionTime" class="easyui-textbox"/>
			所属班级：
	...
	<div id="editDialog" style="padding: 10px">
   		<form id="editForm" method="post">
	    	...
	    	<table id="editTable2" cellpadding="8">
	    		<input id="edit_photo" type="hidden" name="photo" value="/StudentManager_ssm/photo/student.jpg"  />
	    		<tr >
	    			<td>学生姓名:</td>
	    			<td>
                ...
                <tr>
                    <td>入学时间:</td>
                    <td><input type="text" style="width: 200px; height: 30px;" class="easyui-datebox" id="edit_admissionTime" name="admissionTime" data-options="required:true, missingMessage:'请填写入学年份'"> </td>
                </tr>
	    	</table>
	    </form>
	</div>
