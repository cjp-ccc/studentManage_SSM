        ...
        $(function() {
            ...
            $("#delete").click(function(){
                ...
                if(selectLength == 0){
                    ...
                    $.messager.confirm("消息提醒", "确定删除教师信息？", function(r){
                        if(r){
                            $.ajax({
                                type: "post",
                                url: "delete",
                                ...
                                success: function(data){
                                    if(data.type == "success"){
                                        ...
                                        $.messager.alert("消息提醒","该教师还有在授课，请先删除授课信息","warning");
                                        return;
                                    }
                                }
                            });
...
<div id="toolbar">
    ...
    <div>
        ...
        教师名：<input id="search-name" class="easyui-textbox" />
        <%--所属年级：--%>
        <%--<select id="search-profession-id" class="easyui-combobox" style="width: 150px;">--%>
    ...
    <form id="addForm" method="post">
        <table id="addTable2" cellpadding="8">
            <tr >
                <td>教师姓名:</td>
                <td>
                    <input id="add_name"  class="easyui-textbox" style="width: 200px; height: 30px;" type="text" name="name" data-options="required:true, missingMessage:'请填写教师姓名'"  />
                </td>
            </tr>
            <%--<tr >--%>
                <%--<td>登录密码:</td>--%>
            ...
            <tr >
                <td>教师性别:</td>
                <td>
                    <select id="add_sex"  class="easyui-combobox" style="width: 200px;" name="sex" data-options="required:true, missingMessage:'请选择教师性别'">
    ...
    <form id="editForm" method="post">
        ...
        <table id="editTable2" cellpadding="8">
            <tr >
                <td>教师姓名:</td>
                <td>
                    <input id="edit_name"  class="easyui-textbox" style="width: 200px; height: 30px;" type="text" name="name" data-options="required:true, missingMessage:'请填写教师姓名'"  />
                </td>
            </tr>
            ...
            <tr >
                <td>教师性别:</td>
                <td>
                    <select id="edit_sex"  class="easyui-combobox" style="width: 200px;" name="sex" data-options="required:true, missingMessage:'请选择教师性别'">
                        <option value="男">男</option>
                        <option value="女">女</option>
                    </select>
                </td>
