...
<head>
    ...
    <script type="text/javascript">
        ...
        <%--var selectedCourseList = ${selectedCourseListJson};--%>
        $(function() {
            var table;
            ...
            $('#dataList').datagrid({
                ...
                columns: [[
                    ...
                    {field:'attendDate',title:'签到时间',width:150, sortable: true},
                ]],
                toolbar: "#toolbar"
            });
            //设置分页控件
            ...
            $("#addAttend").click(function(){
                table = $("#addAttendTable");

                $("#addAttendDialog").dialog("open");
                ...
                buttons: [
                    {
                        ...
                        iconCls:'icon-add',
                        handler:function(){
                            var validate = $("#addAttendForm").form("validate");
                            if(!validate){
                                $.messager.alert("消息提醒","请检查你输入的数据!","warning");
                                return;
                            } else{

                                var data = $("#addAttendForm").serialize();
                                ...
                                $.ajax({
                                    ...
                                    success: function(data){
                                        if(data.type == "success"){
                                            $.messager.alert("消息提醒","签到成功!","info");
                                            //关闭窗口
                                            $("#addAttendDialog").dialog("close");
...
<div id="toolbar">
    ...
    <div style="float: left;"><a id="addAttend" href="javascript:;" class="easyui-linkbutton" data-options="iconCls:'icon-add',plain:true">签到</a></div>
    <div style="float: left;" class="datagrid-btn-separator"></div>
    </c:if>
    ...
    <form id="addForm" method="post">
        <table id="addTable2" cellpadding="8">
            ...
            <tr >
                ...
                <tr>
                    <td>签到时间:</td>
                    <td><input type="text" style="width: 200px; height: 30px;" class="easyui-datebox" id="add_attendTime" name="attendTime" data-options="required:true, missingMessage:'请填写签到年份'"> </td>
                </tr>
            <%--<tr >--%>
                <%--<td>学生性别:</td>--%>
                <%--<td>--%>
...
<div id="editDialog" style="padding: 10px">
    <form id="editForm" method="post">
        ...
        <table id="editTable2" cellpadding="8">
            ...
            <tr>
                <td>签到时间:</td>
                <td><input type="text" style="width: 200px; height: 30px;" class="easyui-datebox" id="edit_attendTime" name="attendTime" data-options="required:true, missingMessage:'请填写签到时间'"> </td>
            </tr>
            <%----%>
            <%--<tr >--%>
                <%--<td>学生姓名:</td>--%>
...
<!-- 学生签到窗口 -->
<div id="addAttendDialog" style="padding: 10px">
    <form id="addAttendForm" method="post">
        <table id="addAttendTable" cellpadding="8">
            <tr >
                <td>课程:</td>
                <td>
                    <select id="attend_optionalCourseId"  class="easyui-combobox" style="width: 200px;" name="optionalCourseId" data-options="required:true, missingMessage:'请选择课程'">
                        <c:forEach items="${ optionalCourseList}" var="optionalCourse">
                            <option value="${optionalCourse.id }">${optionalCourse.name }</option>
                        </c:forEach>
                    </select>
