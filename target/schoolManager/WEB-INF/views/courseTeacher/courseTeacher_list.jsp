        ...
        $(function() {
            ...
            $('#dataList').datagrid({
                ...
                columns: [[
                    ...
                    {field:'teacherId',title:'教师',width:150, sortable: true,
                    ...
                    {field:'courseId',title:'课程',width:150, sortable: true,
                        formatter:function(value,index,row){
                            for(var i=0;i<courseList.length;i++){
                                if(courseList[i].id == value){
            ...
            $("#editDialog").dialog({
                ...
                onBeforeOpen: function(){
                    ...
                    $("#edit_courseId").combobox('setValue', selectRow.courseId);
            ...
            $("#search-btn").click(function(){
                $('#dataList').datagrid('reload',{
                    ...
                    courseId:$("#search-course-id").combobox('getValue')
                });
            });
        });
...
<div id="toolbar">
    ...
    <div>
        ...
        可授课程：
        <select id="search-course-id" class="easyui-combobox" style="width: 150px;">
            <option value="">全部</option>
    ...
    <form id="addForm" method="post">
        <table id="addTable2" cellpadding="8">
            ...
            <tr >
                <td>老师:</td>
                <td>
                    <select id="add_teacherId"  class="easyui-combobox" style="width: 200px;" name="teacherId" data-options="required:true, missingMessage:'请选择老师'">
                        <c:forEach items="${ teacherList}" var="teacher">
                            <option value="${teacher.id }">${teacher.name }</option>
                        </c:forEach>
                    </select>
                ...
                <tr >
                    <td>课程:</td>
                    <td>
                        <select id="add_courseId"  class="easyui-combobox" style="width: 200px;" name="courseId" data-options="required:true, missingMessage:'请选择老师'">
                            <c:forEach items="${ courseList}" var="course">
                                <option value="${course.id }">${course.name }</option>
                            </c:forEach>
                        </select>
    ...
    <form id="editForm" method="post">
        ...
        <table id="editTable2" cellpadding="8">
            <tr >
                <td>老师:</td>
                <td>
                    <select id="edit_teacherId"  class="easyui-combobox" style="width: 200px;" name="teacherId" data-options="required:true, missingMessage:'请选择老师'">
                        <c:forEach items="${ teacherList}" var="teacher">
                            <option value="${teacher.id }">${teacher.name }</option>
                        </c:forEach>
                    </select>
            ...
            <tr >
                <td>课程:</td>
                <td>
                    <select id="edit_courseId"  class="easyui-combobox" style="width: 200px;" name="courseId" data-options="required:true, missingMessage:'请选择老师'">
                        <c:forEach items="${ courseList}" var="course">
                            <option value="${course.id }">${course.name }</option>
                        </c:forEach>
                    </select>
